...
export default function Electronics() {
  ...
  const subcategories = [
    ...
    },
    {
      id: '7',
      name: 'Game consoles',
      image: 'https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2Fce079d6485e44e09885a2624e3afb404?format=webp&width=800',
      items: ['Consoles'],
      productCount: 89
    },
  ];
          ...
          <>
            ...
            <div className="mb-8">
              <p className="text-muted-foreground">
                Explore our comprehensive electronics collection across various categories
              </p>
            </div>
