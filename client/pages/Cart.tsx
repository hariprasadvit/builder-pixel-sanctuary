...
export default function Cart() {
  ...
  const { getMarketplaceLabel, getDeliveryTime, getCurrencySymbol } =
    useMarketplace();
          ...
          <CardContent className="p-4">
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span>
                  Subtotal (
                  {vendorItems.reduce((sum, item) => sum + item.quantity, 0)}{" "}
                  items)
                </span>
                <span>
                  {currency}
                ...
                <div className="space-y-3">
                  <div className="border-2 border-dashed border-[#0b3b8f]/20 rounded-lg p-4 bg-[#0b3b8f]/6">
                    ...
                    <Button
                      onClick={() => {
                        console.log(
                          "Manual firework test triggered from Cart page",
                        );
                        triggerFireworks();
                      }}
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {currency}
                        {overallTotals.subtotal.toFixed(2)}
                      </span>
                    </div>
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      >
                        {overallTotals.deliveryFee === 0
                          ? "FREE"
                          : `${currency}${overallTotals.deliveryFee.toFixed(2)}`}
                      </span>
                    </div>
                    ...
                    {overallTotals.discountAmount > 0 && (
                      <div className="flex justify-between text-sm text-green-600">
                        ...
                        <span>
                          -{currency}
                          {overallTotals.discountAmount.toFixed(2)}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {currency}
                        {overallTotals.taxAmount.toFixed(2)}
                      </span>
                    </div>
