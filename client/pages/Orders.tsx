...
export default function Orders() {
  ...
  const downloadInvoice = (order: any) => {
    const itemsHtml = order.items
      .map(
        (it: any) =>
          `<tr><td>${it.name}</td><td style='text-align:center'>${it.quantity}</td><td style='text-align:right'>${order.currency}${it.price.toFixed(2)}</td></tr>`,
      )
      .join("");
  ...
  const orders = [
      ...
      items: [
        {
          ...
          image:
            "https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2Fc5af4fad80ff4399a6d668145b207b6e?format=webp&width=200",
          quantity: 1,
          price: 299.99,
    ...
    },
    {
      ...
      items: [
        {
          ...
          image:
            "https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2F71434f1b6c444921b1f60218c7258242?format=webp&width=200",
          quantity: 1,
          price: 149.99,
          category: "electronics",
        },
      ...
      timeline: [
        {
          status: "Order Placed",
          date: "2024-12-12 03:20 PM",
          completed: true,
        },
        {
          status: "Payment Confirmed",
          date: "2024-12-12 03:21 PM",
          completed: true,
        },
    ...
    },
    {
      ...
      items: [
        {
          ...
          image:
            "https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2F840cbc4d5c6c45b891684ac95917a774?format=webp&width=200",
          quantity: 1,
          price: 89.99,
          category: "apparel",
        },
      ...
      timeline: [
        {
          status: "Order Placed",
          date: "2024-12-10 07:15 PM",
          completed: true,
        },
        {
          status: "Payment Confirmed",
          date: "2024-12-10 07:16 PM",
          completed: true,
        },
  ...
  const openCancel = (idx: number) => {
    setActiveOrderIndex(idx);
    setCancelOpen(true);
  };
  const openReturn = (idx: number) => {
    setActiveOrderIndex(idx);
    setReturnOpen(true);
  };
  ...
  const getReturnByForOrder = (order: any) => {
    ...
    const days = order.items.map(
      (it: any) => CATEGORY_WINDOWS[it.category || "electronics"] ?? 7,
    );
    const maxDays = Math.max(...days, 7);
    return new Date(
      new Date(order.date).getTime() + maxDays * 24 * 60 * 60 * 1000,
    );
  };
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant={
                    selectedFilter === "delivered" ? "default" : "outline"
                  }
                ...
                <Button
                  variant={
                    selectedFilter === "in-transit" ? "default" : "outline"
                  }
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      {order.status === "delivered" && (
                        <>
                          <p className="text-xs text-gray-600">
                            Return by{" "}
                            {getReturnByForOrder(order).toLocaleDateString()}
                          </p>
                          <div className="flex flex-wrap gap-3">
                            <Button
                              variant="outline"
                              onClick={() => {
                                setActiveOrderIndex(orders.indexOf(order));
                                setReturnOpen(true);
                              }}
                            >
                      ...
                      {(order.status === "shipped" ||
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-gray-600">
                            You can refuse delivery or return after delivery.
                          </p>
                        </div>
                      )}
