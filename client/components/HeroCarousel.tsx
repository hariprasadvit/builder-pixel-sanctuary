        ...
        <div className="relative overflow-hidden rounded-2xl bg-white">
          ...
          <div className="relative w-full h-[320px] md:h-[340px]">
            {groups.map((pair, gi) => (
              ...
              >
                <div className="grid grid-cols-2 gap-0 p-0 h-full">
                  {pair.map((slide) => (
                    <div key={slide.id} className="relative w-full h-full cursor-pointer bg-white rounded-md overflow-hidden flex items-center justify-center p-0" onClick={() => handleClick(slide)}>
