      ...
      <div className="container mx-auto px-4">
        <div className="rounded-2xl overflow-hidden shadow bg-white">
          <div className="bg-gradient-to-r from-[#e3f2fd] to-[#e1f5fe] p-4">
            <h3
              className={`text-xl md:text-2xl font-bold ${BRAND_GRADIENT_TEXT}`}
            >
              What people are buying around u
            </h3>
            <p className="text-xs md:text-sm text-gray-700/80">
              Curated from reviews, powered by AI.
            </p>
          </div>
          <div className="p-6 grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 place-items-center">
            <SocialSellCard
              ...
              videoPoster={`https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2F8c56ab6c939f497c82b13b00b50d5e04?format=webp&width=800&cb=${Date.now()}`}
              hideWatchButton
              bullets={[
              ...
              sources={[
                {
                  title: "Top review",
                  url: "#",
                  snippet: "Great sound for the price; mic is decent indoors.",
                },
              ]}
            />
            <SocialSellCard
