            ...
            <div className="bg-white rounded-2xl shadow overflow-hidden">
              ...
              <div className="p-4">
                {cat.key === 'electronics' ? (
                  ...
                  <BrandBannerPlaceholder title={`${cat.title} Banner Placeholder`} height="h-40" imageSrc={cat.key === 'beauty' ? "https://cdn.builder.io/api/v1/image/assets%2F1ba648a6a1694e9aa91b762fb1bf4499%2Ffae995da10db42548b572f98c6aadf92?format=webp&width=1440" : undefined} />
                )}
